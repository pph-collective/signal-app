<template>
  <p class="is-size-7">
    This web tool includes information on vaccines administered to Rhode Island
    residents as recorded in the
    <ExternalLink href="https://health.ri.gov/programs/detail.php?pgm_id=156681"
